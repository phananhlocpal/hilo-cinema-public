const CommingSoonTab = () => {
    return (
        <div className="flex justify-center items-center px-4 py-4 md:px-0 lg:px-6 md:py-6 bg-white rounded mt-4 xl:shadow-2xl min-h-[350px]">
            <section className="flex items-center flex-1">
                <div className="flex flex-col w-full ">
                    <h1 className="text-3xl font-extrabold text-center lg:text-5xl 2xl:text-7xl">
                    ...
                    <p className="max-w-3xl mx-auto mt-6 text-lg text-center text-gray-700 dark:text-white md:text-xl">
                        Quý khách vui lòng quy cập trang này lại sau!
                    </p>
